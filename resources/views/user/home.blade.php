             ...
             @endif
                ...
                <li class="nav-item">
                  <form action="{{url('search')}}" method="get" class="form-inline mt-3 mb-3 mr-4" style="float: right;">
                    @csrf
                    <input class="form-control mr-sm-1" type="search" name="search" placeholder="ابحث" aria-label="ابحث">
            ...
            <div dir="rtl" class="col-lg-2  col-md-3 col-sm-6">
                <div class="footer-widget">
                    ...
                    <ul>
                        ...
                        <li><a href="{{url('/ourproduct')}}">منتجات جديدة</a></li>
                        <li><a href="{{url('/')}}">تخفيضات</a></li>
