            ...
            <div class="container" align="center">
              ...
              @endif
                ...
                @foreach ($data as $product )
                  @if($product->action == "Upcoming Product")
                      ...
                      <tbody>
                          ...
                          @if($product->action == "Upcoming Product")
                              <tr>
                                  ...
                                  <td><a class="btn btn-warning" href="{{url('empupdateproduct',$product->id)}}">Update</a></td>
                                  <td><a class="btn btn-danger" href="{{url('empdeleteproduct',$product->id)}}">Delete</a></td>
                                  <td><a class="btn btn-danger" href="{{url('emparchiveproduct',$product->id)}}">move to archive</a></td>
