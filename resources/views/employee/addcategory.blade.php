      ...
      <!-- partial -->
        ...
        <div class="container-fluid page-body-wrapper">
            <div class="container" align="center">
              ...
              @endif
              <h1  class="mt-3" style="color: rgb(234, 20, 20); padding-top: 25px; font-size:40px; font-weight: 900">Add Category</h1>
              <form method="post" action="{{url('empaddcategory')}}" enctype="multipart/form-data">
              @csrf
